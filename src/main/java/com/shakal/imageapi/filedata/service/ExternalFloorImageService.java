...
@Service
public class  ExternalFloorImageService {
	
	@Autowired
	private IExternalFileStorageStrategy externalFileStorage;
	private PathEnum businessPath = PathEnum.MAP;
	
	public String saveFloorImageFile(File file, String fileName) throws FileManagementException {
